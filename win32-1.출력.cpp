	...
	_In_ int       nCmdShow)
{
	...
	// 기본 메시지 루프입니다:
	while (GetMessage(&msg, nullptr, 0, 0)) // 큐에서 읽어오기
	{
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:
	{
		...
		TextOut(hdc, 100, 0, _T("집보내줘"), 4); 
		TextOut(hdc, 100, 100, _T("집보내줘"), lstrlen(_T("집보내줘"))); // TextOut(hdc , x , y , object , length )
		TextOut(hdc, 100, 200, _T("집보내줘"), lstrlen(_T("집보내줘")));
		TextOut(hdc, 100, 300, _T("집보내줘"), lstrlen(_T("집보내줘")));
		...
		Rectangle(hdc, 10, 20, 30, 40); //사각형
		Rectangle(hdc, 10, 20, 40, 70);

		Ellipse(hdc, 100, 200, 400, 700); // 원
